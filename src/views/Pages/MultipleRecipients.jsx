...
import { sendMultipleSms } from "../../actions/memberActions"
...
class MemberList extends React.Component {
  ...
  onSelectChange(e) {
    this.setState({
      selectedRecipients: [...this.state.selectedRecipients, e.value]
    })
  }
  ...
  async onSubmit(e) {
    ...
    const sms = {
      smsRecipients: this.state.selectedRecipients,
      message: this.state.sms
    }

    if (!this.state.selectedRecipients || !this.state.sms) {
      this.showNotification("tl")
    } else {
      await this.props
        .sendMultipleSms(sms, this.props.history)
        .then(response => {
                ...
                <form onSubmit={this.onSubmit}>
                  ...
                  <GridContainer>
                    ...
                    <GridItem xs={12} sm={12} md={6}>
                      <legend>Selected Recipients</legend>
                      <TagsInput
...
MemberList.propTypes = {
  ...
  sendMultipleSms: PropTypes.func.isRequired,
...
const enhance = compose(
  ...
  connect(
    mapStateToProps,
    { listSmsMembers, sendMultipleSms }
  )
)
