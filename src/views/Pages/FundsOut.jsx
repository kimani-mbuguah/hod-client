...
import { postFundsOut } from "../../actions/fundsAction"
...
class FundsOut extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      amount: "",
  ...
  async onSubmit(e) {
    ...
    await this.props
      .postFundsOut(fundsOutData, this.props.history)
      .then(response => {
          ...
          <form onSubmit={this.onSubmit}>
            <Card>
              <CardHeader color="rose" text>
                <CardText color="rose">
                  <h4 className={classes.cardTitle}>Funds Out</h4>
                </CardText>
              </CardHeader>
              <CardBody>
                <GridContainer>
...
FundsOut.propTypes = {
  ...
  postFundsOut: PropTypes.func.isRequired
}
...
export default enhance(withRouter(FundsOut))
